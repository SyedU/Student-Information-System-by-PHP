	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">Add Roll and Code</div>
				<div class="panel-body">
					<form role="form" action="addrollpost.php" method="post">
						<fieldset>
              <div class="form-group">
								<input class="form-control" placeholder="Name of Student" name="name" type="text" autofocus="">
							</div>
							...
							<div class="form-group">
								<input class="form-control" placeholder="Roll No" name="roll" type="number" value="">
							</div>
              <div class="form-group">
								<input class="form-control" placeholder="Code No" name="code" type="number" value="">
							</div>
							<div class="checkbox">
								<label>
